(function () {
  ...
  function injectSwitcher() {
    ...
    btn.style.cssText = 'font-family:var(--mono);font-size:9px;letter-spacing:.06em;width:34px;font-weight:600;cursor:pointer';
    ...
    wrapper.appendChild(btn); wrapper.appendChild(dd);
    const dmBtn = document.getElementById('dm-btn');
    dmBtn ? navR.insertBefore(wrapper, dmBtn) : navR.appendChild(wrapper);
  }

  function init() { injectSwitcher(); applyLang(detectLang()); }
